...
export const CLICKHOUSE_PROTOCOL = getEnv('CLICKHOUSE_PROTOCOL');
export const CLICKHOUSE_HOST = getEnv('CLICKHOUSE_HOST');
export const CLICKHOUSE_PORT = getEnv('CLICKHOUSE_PORT');
export const CLICKHOUSE_USERNAME = getEnv('CLICKHOUSE_USERNAME');
export const CLICKHOUSE_PASSWORD = getEnv('CLICKHOUSE_PASSWORD');
export const CLICKHOUSE_DATABASE = getEnv('CLICKHOUSE_DATABASE');
