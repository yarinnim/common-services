# Project Brief: Cart Service

## Overview

`@common_services/cart` is a Vibe platform microservice in the
`common-services` monorepo. It is the HTTP API and data layer for cart
...
- Cart domain APIs documented in `memory-bank/feature/`
