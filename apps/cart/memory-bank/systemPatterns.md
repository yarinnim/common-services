# System Patterns: Cart Service

## Architecture Overview

### Microservice

- Package: `apps/cart` (`@common_services/cart`)
...
- Resource paths are plural (`/carts`, not `/cart`)
- Detail is a nested `/:id` with middleware; do not use `carts/:cartId`
